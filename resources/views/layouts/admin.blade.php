                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="/buatuser" class="waves-effect">
                                    <i class="dripicons-meter"></i>
                                    <span> Buat User <span class="badge badge-success badge-pill float-right">3</span></span>
                                </a>
                            </li>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-broadcast"></i> <span> Buku </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="/buku">Buku</a></li>
                                    <li><a href="/buku/laporan">Laporan Buku</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
